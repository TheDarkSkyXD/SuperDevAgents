...
Before spawning investigators, list the connectors and tools exposed by the active harness. Use its available-tools map when present. Do not assume a harness-specific filesystem location for enabled services.
