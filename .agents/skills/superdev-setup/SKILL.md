---
name: superdev-setup
description: "Configure a repository for SuperDev by setting its issue tracker, triage labels, domain docs, role-to-model map, and high reasoning defaults. Use for /superdev-setup, first-time SuperDev setup, or changes to either configuration."
---
